...
const maicFAQs = [
  {
    question: 'OpenMAIC是什么？',
    answer: 'OpenMAIC是清华大学推出的开源AI互动课堂平台，能将PDF或主题一键生成多智能体沉浸式学习体验。',
  },
  {
    question: 'OpenMAIC免费吗？',
    answer: '是的，OpenMAIC是开源免费项目，采用AGPL许可证，任何人都可以免费使用和部署。',
  },
  {
    question: '需要编程基础吗？',
    answer: '不需要！用户可以直接访问open.maic.chat在线使用，也可以通过OpenClaw在飞书、微信等平台直接生成课堂。',
  },
]
