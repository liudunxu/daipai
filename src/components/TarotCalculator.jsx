  ...
  return (
    <>
      ...
      <div className="mt-8 bg-white/5 border border-white/10 rounded-2xl p-6">
        <h3 className="text-white font-bold mb-3 text-center">塔罗牌周边</h3>
        <p className="text-white/60 text-sm mb-4 text-center">探索更多塔罗牌世界</p>
        <div className="flex flex-wrap justify-center gap-3">
          <AffiliateLink url="https://search.jd.com/Search?keyword=韦特塔罗牌" text="韦特塔罗牌" platform="jingdong" />
          <AffiliateLink url="https://search.jd.com/Search?keyword=塔罗牌入门" text="塔罗牌入门书" platform="jingdong" />
        </div>
      </div>
    </>
  )
