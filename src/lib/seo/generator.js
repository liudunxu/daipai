...
- H3标题：问句或金句
- 段落：2-3行
- **每节写完立即插入一张相关图片**，不要集中放在文章末尾！
- 图片要紧跟文字内容，形成"文字→图片→文字"的节奏
- 示例：写完一段"什么是AI"，立刻跟上 ![AI相关图片](URL)，再继续下一段

### 图片要求（重要！）
- **3-5张图片必须分散在文章各处**，每张图要紧跟相关文字段落
- 禁止把所有图片堆在文章结尾
- 图片下方可加简短图注说明
- 优先使用参考资料中的图片URL（Pexels/Pixabay/Unsplash/Wikipedia）
- 格式：![图片描述](图片URL)
